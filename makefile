OBJECTS = build/main.o build/soundbank.o build/sprs.o build/bgtwo.o build/rotostuff.o
...
SOURCES = src/main.c src/rotostuff.c src/sprs.c src/bgtwo.c
ELFS = build/main.elf
ASM = src/soundbank.s
