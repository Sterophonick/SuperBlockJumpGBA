OBJECTS = build/bytecopy.o build/main.o build/flash.o build/soundbank.o build/sprs.o build/bgtwo.o build/rotostuff.o build/shrink1.o build/shrink2.o build/shrink3.o build/shrink4.o build/shrink5.o build/shrink6.o build/shrink8.o build/shrink7.o build/shrink9.o build/shrinka.o build/ach00.o build/ach01.o build/ach02.o build/ach03.o build/ach04.o build/ach05.o build/ach06.o build/ach07.o build/ach08.o build/ach09.o build/ach0a.o build/ach0b.o build/ach0c.o build/ach0d.o build/ach0e.o build/ach0f.o build/ach10.o build/ach11.o build/ach12.o build/ach13.o
...
build/%.o: src/%.s
	$(PREFIX)gcc $(CFLAGS) -marm -mthumb-interwork -c $< -o $@
...
build/main.elf: $(OBJECTS)
	$(PREFIX)gcc $(SPECS) $(ARCH) $(OBJECTS) -L ./libheart $(LIBS) -o build/main.elf
