OBJECTS = build/main.o build/soundbank.o build/sprs.o build/bgtwo.o build/rotostuff.o build/shrink1.o build/shrink2.o build/shrink3.o build/shrink4.o build/shrink5.o build/shrink6.o build/shrink8.o build/shrink7.o build/shrink9.o build/shrinka.o
